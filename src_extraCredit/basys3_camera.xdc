...
set_property PULLUP true [get_ports camera_sioc]
...
####################################################################################
# Filter Selection Switches (SW0-SW2) and byte-swap toggle (SW3)
####################################################################################
...
set_property PACKAGE_PIN W17 [get_ports byte_swap]
set_property IOSTANDARD LVCMOS33 [get_ports byte_swap]

# set_property PACKAGE_PIN W15 [get_ports yuv_mode]
# set_property IOSTANDARD LVCMOS33 [get_ports yuv_mode]

set_property PACKAGE_PIN V15 [get_ports pclk_invert]
set_property IOSTANDARD LVCMOS33 [get_ports pclk_invert]
