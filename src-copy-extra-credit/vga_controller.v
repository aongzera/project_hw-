...
module vga_controller(
    ...
    // Position of the NEXT pixel — use these to address a 1-cycle-latency
    // frame buffer so the returned data lines up with x_pos / y_pos.
    output wire [9:0] x_next_pos,
    output wire [9:0] y_next_pos
);
    ...
    assign x_next_pos = h_next;
    assign y_next_pos = v_next;
